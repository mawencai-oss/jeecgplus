...
<div class="row  border-bottom white-bg dashboard-header">
    ...
    <div class="col-sm-5">
        ...
        <p>智能开发平台是一款基于代码生成器的J2EE快速开发平台，开源界“小普元”超越传统商业企业级开发平台。引领新的开发模式(Online Coding模式(自定义表单)->代码生成器模式->手工MERGE智能开发)， 可以帮助解决Java项目60%的重复工作，让开发更多关注业务逻辑。既能快速提高开发效率，帮助公司节省人力成本，同时又不失灵活性。她可以用于所有的Web应用程序，如:<b>MIS</b>，<b>CRM</b>，<b>OA</b>，<b>ERP</b>，<b>CMS</b>，<b>网站后台</b>，<b>微信管家</b>，等等，当然，您也可以对她进行深度定制，以做出更强系统。</p>
        <p>
            <b>当前版本：</b>v10.0.1
        </p>
        <p>
        ...
        <div class="col-sm-4">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <p><i class="fa fa-weixin"></i>微信公众号：<a href="javascript:;">筹备中，敬请期待。。。</a>
                    </p>
                    <p><i class="fa fa-credit-card"></i> 邮箱：<a href="javascript:;" class="邮箱">1000222@126.com</a>
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h5 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#version" href="#v50">v10.0.1</a><code class="pull-right">2017.02.08</code>
                                    </h5>
                                </div>
