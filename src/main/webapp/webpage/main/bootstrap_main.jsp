...
<div class="container-fluid"><a class="brand" href="http://www.bjzzf.info" target="_blank"><t:mutiLang langKey="common.platform"/> &nbsp;&nbsp;<span class="slogan"></span></a>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; <t:mutiLang langKey="common.copyright"/><a href="http://www.bjzzf.info" title="JEECGPLUS Framework  <t:mutiLang langKey="system.version.number"/>">JEECG Framework  <t:mutiLang langKey="system.version.number"/></a></li>
	<li style="display: inline;">&nbsp;<t:mutiLang langKey="common.copyright"/><t:mutiLang langKey="common.browser"/>:<a title="JEECGPLUS Framework  <t:mutiLang langKey="system.version.number"/>" href="http://www.bjzzf.info">JEECGPLUS Framework  <t:mutiLang langKey="system.version.number"/></a></li>
</ul>
</div>
</footer>
